...
public class WalkerActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View view) {
    	switch(view.getId()) {
    		case R.id.send:
    			...
    			columns.add("step");
    			WrapAccesor.PostStep step_poster = new WrapAccesor.PostStep(columns,this);
    			step_poster.execute(UserData.USERHASH,String.valueOf(mCount));
    			mCount = 0;
    			break;
    	}
    }
